...
@Deprecated
public class EggQuest extends Feature implements WorldRenderEvents.AfterEntities {

//	private static final Block EGG = Blocks.TURTLE_EGG;
//	
...
//		if (isOnServer() && FlagClash.getQuest() == Quest.EGG_COLLECTOR) {
...
//				drawLine(context.matrixStack(), pos, context.camera(), new Color(64, 255, 64));
//			}
//			
...
//						if (state.getBlock() == EGG) blocks.add(pos);
//					}
//				}
//			}
//		}

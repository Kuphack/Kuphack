...
public class MinehutServerListScreen extends Screen {
    ...
    protected void init() {
        ...
        if (this.initialized) {
            ...
            this.serverListWidget = new MinehutServerListWidget(this, this.client, this.width, this.height);
        }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
    	...
    	this.categoryWidget.setFocused(false);
    	...
    	new Thread(() -> {
	        ...
	        try {
				...
				servers = servers.stream()
					.filter(Predicate.not(Server::isSubserver))
					.toList();
				System.out.println(servers.size());

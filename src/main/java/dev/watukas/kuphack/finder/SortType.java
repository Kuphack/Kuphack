...
import dev.watukas.kuphack.finder.comparators.ServerActivityComparator;
import dev.watukas.kuphack.finder.comparators.ServerTrendingComparator;
import dev.watukas.kuphack.finder.comparators.ServerUptimeComparator;

public enum SortType {

	ACTIVITY("Sorts by the amount of players online.", new ServerActivityComparator()),
